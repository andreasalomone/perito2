...
class Case(Base):
    ...
    importo_liquidato: Mapped[Optional[Decimal]] = mapped_column(
    ...
    riferimento_assicurato: Mapped[Optional[str]] = mapped_column(
    ...
    riferimento_broker: Mapped[Optional[str]] = mapped_column(
        String(255), nullable=True
    )
    destinatari: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)

    # Transport
    mezzo_di_trasporto: Mapped[Optional[str]] = mapped_column(
        String(255), nullable=True
    )
    descrizione_mezzo_di_trasporto: Mapped[Optional[str]] = mapped_column(
        String(255), nullable=True
    )

    # Location & Processing
    luogo_intervento: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    genere_lavorazione: Mapped[Optional[str]] = mapped_column(
        String(255), nullable=True
    )
