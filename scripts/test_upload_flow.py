...
def test_upload_flow():
    ...
    files_to_upload = [
        ...
        ('tests/temp_extraction_test/test.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document')
    ]
    ...
    try:
        ...
        while True:
            ...
            try:
                status_response = requests.get(f"{BASE_URL}/report/status/{report_id}", auth=auth)
            except requests.exceptions.ConnectionError:
